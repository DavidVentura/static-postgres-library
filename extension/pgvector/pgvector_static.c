/*
 * vector_static.c - Static wrapper for vector extension
 *
...
const StaticExtensionFInfo vector_static_finfo[] = {
...
register_vector(void)
{
	static const EmbeddedFile control_file = {
		.filename = "/tmp/pg-embedded-install/share/postgresql/extension/vector.control",
		.data = vector_control,
		.len = vector_control_len
	};
	static const EmbeddedFile script_file = {
		.filename = "/tmp/pg-embedded-install/share/postgresql/extension/vector--0.8.1.sql",
		.data = vector_script,
		.len = vector_script_len
	};
